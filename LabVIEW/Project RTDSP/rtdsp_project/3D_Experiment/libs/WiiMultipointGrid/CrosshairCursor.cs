...
namespace WiiMultipointGrid
{
    class CrosshairCursor
    {
        ...
        public CrosshairCursor(Device dev, int color, float size)
        {
            ...
            cursorBuffer = new VertexBuffer(typeof(CustomVertex.PositionColored), 4 + 2 * circleSegments, dev, 0, CustomVertex.PositionColored.Format, Pool.Managed);
        ...
        public void Render(Device device)
        {
            ...
            device.DrawPrimitives(PrimitiveType.LineList, 0, 2 + circleSegments);
        }
